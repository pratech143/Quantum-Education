    ...
    <section className="py-16 lg:py-24 font-body" style={{ background: '#F7F6F3' }}>
      <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-20">
          <h2 className="font-headline text-4xl font-bold text-primary mb-4 tracking-tight">Our Premium Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="p-10 rounded-xl bg-white shadow-sm border border-black/5 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 group animate-in fade-in slide-in-from-bottom-4"
