...
function buildDetail(u: {
  name: string; slug: string; desc: string; website: string;
...
async function seed() {
  ...
  const australia = await prisma.country.create({
    data: {
      ...
      heroImage: '', heroSubtitle: 'World-class education in the Land Down Under',
  ...
  for (const u of ausUniData) {
    ...
    await prisma.university.create({
      data: { name: u.name, slug: u.slug, description: u.desc, location: u.location, image: '', ranking: u.ranking, qsRanking: u.qs, tagline: u.tagline, website: u.website, type: 'UNIVERSITY', countryId: australia.id, ...detail } as any
    });
  }
  ...
  // ── AUSTRALIA COLLEGES ─────────────────────────────────
  const ausColleges = [
    { name: 'Technical Institute of Victoria', slug: 'technical-institute-of-victoria', location: 'Melbourne', desc: 'Providing industry-relevant vocational training in engineering, construction, and sustainable technologies.' },
    { name: 'Pacific College of Technology', slug: 'pacific-college-of-technology', location: 'Sydney', desc: 'A premier destination for information technology, business management, and digital innovation programs.' },
    { name: 'Academy of Culinary Arts', slug: 'academy-of-culinary-arts', location: 'Brisbane', desc: 'Excellence in hospitality and culinary arts, focusing on professional skill development and global placements.' },
    { name: 'Health Careers Australia', slug: 'health-careers-australia', location: 'Adelaide', desc: 'Specialized vocational training for nursing, aged care, and community health services with clinical placements.' },
    { name: 'Creative Design College', slug: 'creative-design-college', location: 'Perth', desc: 'Nurturing creative talent through industry-led programs in graphic design, animation, and visual arts.' },
    { name: 'Global Business Academy', slug: 'global-business-academy', location: 'Gold Coast', desc: 'Empowering future leaders with practical business management and leadership qualifications.' },
  ];
  for (const c of ausColleges) {
    ...
    await prisma.university.create({
      data: { name: c.name, slug: c.slug, description: c.desc, location: c.location, image: '', ranking: 999, website: 'https://example.com', type: 'COLLEGE', countryId: australia.id, ...detail } as any
    });
  }
  ...
  const otherUnis = [
    { countryId: usa.id, unis: [
      { name: 'MIT', slug: 'mit', desc: 'The Massachusetts Institute of Technology is the world\'s #1 university for engineering and technology, driving innovation from quantum computing to clean energy.', qs: '#1', ranking: 1, tagline: '#1 Engineering', website: 'https://web.mit.edu',
      ...
      { name: 'Stanford University', slug: 'stanford-university', desc: 'Located in the heart of Silicon Valley, Stanford is a world leader in entrepreneurship, technology, and interdisciplinary research.', qs: '#2', ranking: 2, tagline: 'Silicon Valley Innovation', website: 'https://www.stanford.edu',
      ...
      { name: 'Harvard University', slug: 'harvard-university', desc: 'The oldest institution of higher learning in the United States, Harvard is synonymous with academic prestige, producing world leaders across every field.', qs: '#4', ranking: 4, tagline: 'Academic Heritage', website: 'https://www.harvard.edu',
    ...
    { countryId: uk.id, unis: [
      { name: 'University of Oxford', slug: 'university-of-oxford', desc: 'The oldest university in the English-speaking world, Oxford combines centuries of tradition with cutting-edge research across every discipline.', qs: '#3', ranking: 3, tagline: 'World Leader', website: 'https://www.ox.ac.uk',
      ...
      { name: 'Imperial College London', slug: 'imperial-college-london', desc: 'A world top-10 university focused exclusively on science, engineering, medicine, and business, located in the heart of London.', qs: '#6', ranking: 6, tagline: 'Science & Engineering focus', website: 'https://www.imperial.ac.uk',
      ...
      { name: 'University of Manchester', slug: 'university-of-manchester', desc: 'A prestigious Russell Group university known for groundbreaking discoveries including graphene, and a proud Red Brick heritage.', qs: '#32', ranking: 32, tagline: 'Red Brick Prestige', website: 'https://www.manchester.ac.uk',
    ...
    { countryId: canada.id, unis: [
      { name: 'University of Toronto', slug: 'university-of-toronto', desc: 'Canada\'s #1 university and a global top-25 institution, leading in research across AI, medicine, engineering, and the humanities.', qs: '#21', ranking: 21, tagline: '#1 in Canada', website: 'https://www.utoronto.ca',
      ...
      { name: 'UBC', slug: 'ubc', desc: 'The University of British Columbia is a global research powerhouse on Canada\'s stunning Pacific coast, ranked among the world\'s top 40 universities.', qs: '#34', ranking: 34, tagline: 'West Coast Excellence', website: 'https://www.ubc.ca',
      ...
      { name: 'McGill University', slug: 'mcgill-university', desc: 'One of Canada\'s most prestigious research universities, located in vibrant Montreal, known for excellence in medicine, law, and the sciences.', qs: '#30', ranking: 30, tagline: 'Prestigious Research', website: 'https://www.mcgill.ca',
    ...
    { countryId: germany.id, unis: [
      { name: 'TU Munich', slug: 'tu-munich', desc: 'Germany\'s #1 technical university and a European leader in engineering, technology, and natural sciences with strong industry ties to BMW, Siemens, and SAP.', qs: '#37', ranking: 37, tagline: 'Elite Engineering', website: 'https://www.tum.de',
      ...
      { name: 'Heidelberg University', slug: 'heidelberg-university', desc: 'Germany\'s oldest university, founded in 1386, Heidelberg is a research powerhouse in natural sciences, medicine, and the humanities.', qs: '#47', ranking: 47, tagline: 'Oldest in Germany', website: 'https://www.uni-heidelberg.de',
      ...
      { name: 'Humboldt University', slug: 'humboldt-university', desc: 'Located in the heart of Berlin, Humboldt University pioneered the modern research university concept and continues to shape global academia.', qs: '#120', ranking: 120, tagline: 'Berlin Innovation', website: 'https://www.hu-berlin.de',
  ...
  for (const group of otherUnis) {
    for (const u of group.unis) {
      const detail = buildDetail({ ...u, howToApply: defaultApplySteps });
      await prisma.university.create({
        data: { name: u.name, slug: u.slug, description: u.desc, location: 'National', image: '', ranking: u.ranking, qsRanking: u.qs, tagline: u.tagline, website: u.website, type: 'UNIVERSITY', countryId: group.countryId, ...detail } as any
      });
    }
  }
  ...
  // ═══════════════════════════════════════════════════════
  const alumniList = [
    { name: 'Anjali S.', university: 'University of Sydney, Australia', degree: 'Masters in Biotech', country: 'australia', quote: 'Global Scholar gave me the confidence and roadmap to pursue my dream degree. The support was exceptional at every step.', image: '' },
    { name: 'Sandeep K.', university: 'University of Toronto, Canada', degree: 'MBA Finance', country: 'canada', quote: 'From visa application to settling in Toronto — the team handled everything. I could focus entirely on my studies.', image: '' },
    { name: 'Ritika P.', university: 'Monash University, Australia', degree: 'Nursing', country: 'australia', quote: 'They matched me with the perfect nursing program. Within a year I already had clinical placement offers across Melbourne.', image: '' },
    { name: 'Deepak B.', university: 'Technical University of Munich, Germany', degree: 'MEng Automotive', country: 'germany', quote: "Studying at TU Munich felt impossible until Global Scholar walked me through every requirement. Now I'm living my dream.", image: '' },
    { name: 'Aaryav M.', university: 'University of Oxford, UK', degree: 'Global Policy', country: 'uk', quote: "The Global Scholar didn't just help with my visa; they helped me find a community. Oxford has been truly transformative.", image: '' },
    { name: 'Priya R.', university: 'MIT, USA', degree: 'AI Research', country: 'usa', quote: "From the first consultation to landing in Boston, the support was seamless. I'm now pursuing my dream in AI research.", image: '' },
  ];
