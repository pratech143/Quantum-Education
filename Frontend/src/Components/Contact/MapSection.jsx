...
const MapSection = () => {
  return (
    <section className="py-16 md:py-20 px-12 bg-surface-container-low">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="w-full h-[500px] rounded-3xl overflow-hidden shadow-2xl relative"
        >
          <iframe
          ...
          <motion.div
            ...
            className="absolute bottom-6 left-6 right-6 md:right-auto bg-white p-6 rounded-2xl shadow-xl max-w-xs"
          >
