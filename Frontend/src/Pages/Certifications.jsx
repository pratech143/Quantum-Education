...
const Certifications = () => {
    ...
    return (
        <main className="min-h-screen pt-0 pb-20 bg-background font-body relative">
            ...
            <div className={isReady ? 'opacity-100 transition-opacity duration-500' : 'opacity-0'}>
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="mt-16 p-12 rounded-[2rem] bg-surface-container-low border border-black/5"
                    >
