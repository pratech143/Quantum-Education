...
const ContactFormSection = () => {
  return (
    // Added 'min-h-screen' and 'flex items-center' to ensure the section 
    // itself centers its content vertically and horizontally.
    <section className="min-h-screen flex items-center justify-center py-24 px-6 md:px-12 bg-surface">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center justify-center w-full">
        ...
        {/* LEFT: Form card */}
        <div className="lg:col-span-7 bg-surface-container-lowest p-8 md:p-12 rounded-2xl shadow-xl shadow-black/5 order-2 lg:order-1">
