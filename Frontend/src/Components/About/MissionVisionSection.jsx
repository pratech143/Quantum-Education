  ...
  return (
    <section className="py-24 bg-surface">
      <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-12">
        <div className="bg-surface-container-lowest p-12 rounded-xl shadow-sm space-y-4 hover:shadow-md transition-shadow group">
        ...
        <div className="bg-primary p-12 rounded-xl space-y-4 shadow-xl group">
