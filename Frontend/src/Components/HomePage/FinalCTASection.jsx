      ...
      <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="relative rounded-[2rem] overflow-hidden hero-gradient p-12 md:p-16 lg:p-24 text-center shadow-2xl shadow-primary/20">
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
            <h2 className="font-headline text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-[1.1] tracking-tight">
              Ready to Begin Your Global Academic Journey?
            </h2>
            <p className="text-secondary-fixed text-lg md:text-xl mb-12 leading-relaxed opacity-90">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 w-full sm:w-auto">
              <button className="bg-white text-primary-container px-8 py-4 sm:px-10 sm:py-5 rounded-xl font-headline font-bold text-lg sm:text-xl hover:scale-[1.05] transition-transform shadow-2xl shadow-black/10 active:scale-95 w-full sm:w-auto">
                Start Free Application
              </button>
              <button className="border-2 border-white/30 text-white px-8 py-4 sm:px-10 sm:py-5 rounded-xl font-headline font-bold text-lg sm:text-xl hover:bg-white/10 transition-colors active:scale-95 w-full sm:w-auto">
                Contact Our Team
              </button>
            </div>
          </div>
