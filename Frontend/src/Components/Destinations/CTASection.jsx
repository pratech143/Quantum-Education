  ...
  return (
    <section className="py-24 px-6 bg-surface">
      <div className="max-w-5xl mx-auto primary-gradient p-12 md:p-20 rounded-xl text-white text-center relative overflow-hidden">
        ...
        <p className="text-on-primary-container text-lg mb-12 max-w-xl mx-auto relative z-10">Your global future starts with a single conversation. Book a free consultation with our expert advisors today.</p>
